...
reveal_type(Person.__required_keys__)  # revealed: tuple[Literal["name"], Literal["age"]]
...
reveal_type(OptionalPerson.__optional_keys__)  # revealed: tuple[Literal["name"], Literal["age"]]
...
# TODO: functional TypedDict instantiation with keyword arguments needs proper __init__ synthesis
